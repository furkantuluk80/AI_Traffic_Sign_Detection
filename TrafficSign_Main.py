...
batch_size_val = 50  # Kaç tane resim birlikte işlenecek
steps_per_epoch_val = 2000
epochs_val = 30
imageDimesions = (32, 32, 3)
testRatio = 0.2  # Test için toplam resimlerin yüzde kaçı kullanılacak
validationRatio = 0.2  # kalan train resimlerin yüzde kaçı doğrulama için olacak
###################################################
